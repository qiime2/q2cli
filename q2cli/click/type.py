    ...
    def _convert_input(self, value, param, ctx):
        ...
        try:
            try:
                ...
                # If we made it here, QIIME 2 was confident that the thing we are
                # trying to load is a QIIME 2 Result, however, we have run into
                # some kind of catastrophic error.
                header = 'There was a problem loading %s as a QIIME 2 Result:' % value
