...
qiime dev assert-result-data input-path right2.qza --zip-data-path ints.txt --expression 1
qiime dev assert-result-type input-path right2.qza --qiime-type IntSequence1
qiime dev assert-result-type input-path out-map1.qza --qiime-type Mapping"""),  # noqa: 501
