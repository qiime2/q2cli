...
class CliTests(unittest.TestCase):
    ...
    def test_plugin_list_commands(self):
        ...
        self.assertTrue('split_ints' in commands)
        self.assertTrue('split_ints_markdown' in commands)
        self.assertTrue('mapping_viz' in commands)

    def test_extract(self):
        in1_path = os.path.join(self.tempdir, 'a1.qza')
        self.artifact1.save(in1_path)

        result = self.runner.invoke(
            tools, ['extract', in1_path, '--output-dir', self.tempdir])
    ...
    def test_split_ints(self):
        ...
        result = self.runner.invoke(
            command, ['split_ints', '--i-ints', in1_path,
    ...
    def test_qzv_extension(self):
        ...
        result = self.runner.invoke(
            command, ['most_common_viz', '--i-ints', in1_path,
